...
- name the post like: **µOS++ architecture-cortexm-xpack v4.0.1 released**
...
- `npm dist-tag add @micro-os-plus/architecture-cortexm-xpack@4.0.1 latest`
- `npm dist-tag ls @@micro-os-plus/architecture-cortexm-xpack`
...
- paste the release name like **µOS++ architecture-cortexm-xpack v4.0.1 released**
