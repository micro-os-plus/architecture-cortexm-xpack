...
- name the post like: **µOS++ architecture-cortexm-xpack v3.0.0 released**
...
- `npm dist-tag add @micro-os-plus/architecture-cortexm-xpack@3.0.0 latest`
- `npm dist-tag ls @@micro-os-plus/architecture-cortexm-xpack`
...
- paste the release name like **µOS++ architecture-cortexm-xpack v3.0.0 released**
